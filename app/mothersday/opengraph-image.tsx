...
/**
 * Open Graph image for /mothersday — A/B variant of /win. Identical OG so
 * the social-share preview looks the same regardless of which landing
 * page friends are sharing. Same design as app/win/opengraph-image.tsx.
 */
