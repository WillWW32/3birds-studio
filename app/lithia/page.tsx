      ...
      <section className="relative gradient-hero text-white pt-28 pb-20">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto mb-8">
            As one of Lithia Toyota&apos;s most valued customers, you&apos;ve
            been selected to receive a complimentary professional portrait
            session at 3 Birds Studio.
          </p>
          <a
            href="#claim"
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-3xl shadow-sm overflow-hidden">
              <div className="h-52 bg-gradient-to-br from-emerald-700 via-teal to-emerald-500 flex items-center justify-center">
                <div className="text-center text-white">
                  ...
                  <p className="text-xs uppercase tracking-widest opacity-70">Council Grove State Park</p>
                </div>
              </div>
              <div className="p-6">
                <h3 className="font-display text-xl font-bold text-navy mb-2">Outdoor Portraits</h3>
            ...
            <div className="bg-white rounded-3xl shadow-sm overflow-hidden">
              <div className="h-52 bg-gradient-to-br from-gray-900 via-gray-800 to-navy flex items-center justify-center">
                <div className="text-center text-white">
                  <p className="text-5xl mb-2">🎨</p>
                  <p className="text-xs uppercase tracking-widest opacity-70">Missoula Studio</p>
                </div>
              </div>
              <div className="p-6">
                <h3 className="font-display text-xl font-bold text-navy mb-2">Legacy Studio Session</h3>
                <ul className="text-gray-500 text-sm space-y-1.5">
