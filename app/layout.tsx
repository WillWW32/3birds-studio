...
// Campaign/booking pages read in a book serif (the ClickFunnels-era look
// William wants kept). Scoped via the .serif-page class, never global.
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/images/summer-banner-photo.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["/images/summer-banner-photo.jpg"],
  },
  verification: {
    other: {
...
export const viewport: Viewport = {
  themeColor: "#000000", // pure black — matches footer + brand
  width: "device-width",
  initialScale: 1,
};
