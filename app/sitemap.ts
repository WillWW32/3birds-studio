...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/book/outdoor`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
    { url: `${BASE}/book/legacy`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
    { url: `${BASE}/book/viewing`, lastModified: now, changeFrequency: "weekly", priority: 0.6 },
    { url: `${BASE}/book/consult`, lastModified: now, changeFrequency: "weekly", priority: 0.6 },
    { url: `${BASE}/book/wedding`, lastModified: now, changeFrequency: "weekly", priority: 0.5 },
